    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                // Copy the received string data to a buffer
                char received_string[param->write.len + 1];  // +1 for null-termination
                memcpy(received_string, param->write.value, param->write.len);
                received_string[param->write.len] = '\0';  // Ensure null-termination
